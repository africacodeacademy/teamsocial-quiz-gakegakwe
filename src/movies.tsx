...
export default function Movies() {
	const questions = [
		...
		{
			questionText: 'What are the dying words of Charles Foster Kane in Citizen Kane?',
			answerOptions: [
		...
		{
			questionText: 'What pop vocal group performs at the wedding in Bridesmaids?',
			answerOptions: [
		...
		{
			questionText: 'In "The Lion King," Mufasa dies from being trampled by a pack of:?',
			answerOptions: [
		...
		{
			questionText: 'Finish this line from "Jaws": "You re gonna need a bigger ________."',
			answerOptions: [
		...
		{
			questionText: 'What 1970 movie marked the feature debut of Arnold Schwarzenegger?',
			answerOptions: [
